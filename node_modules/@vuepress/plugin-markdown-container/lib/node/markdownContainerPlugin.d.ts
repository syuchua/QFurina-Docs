...
export type MarkdownItContainerRenderFunction = (tokens: Token[], index: number, options: unknown, env: MarkdownEnv, self: Renderer) => string;
...
export declare const markdownContainerPlugin: ({ type, after, before, locales, validate, marker, render: renderOptions, }: MarkdownContainerPluginOptions) => Plugin;
