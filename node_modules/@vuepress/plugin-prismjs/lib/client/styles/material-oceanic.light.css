...
[data-theme=light] {
  --code-c-text: #c3cee3;
  --code-c-bg: #263238;
  --code-c-highlight-bg: #2c3e47;
  --code-c-line-number: rgba(195, 206, 227, 0.67);
}
[data-theme=light] div[class*=language-] pre ::selection {
  background: #363636;
}
[data-theme=light] .language-css > code,
[data-theme=light] .language-sass > code,
[data-theme=light] .language-scss > code {
  color: #fd9170;
}
[data-theme=light] [class*=language-] .namespace {
  opacity: 0.7;
}
...
[data-theme=light] .token.attribute {
  color: #c3e88d;
}
